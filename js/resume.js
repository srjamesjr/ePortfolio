function P_Resume() {
    ...
    d.classList = "content";
    d.innerHTML =
        "<img src=\"../images/Resume.png\" alt=\"Resume (image not found)\">" +
        "";
...
function P_Goals() {
    ...
    d.classList = "content";
    d.innerHTML =
        '<div class=\"center-text\"><h4>Short-term Goals</h4></div> \
        <p>&emsp;&emsp;&emsp;&emsp;Learn Laravel: For my work term, I\'m product owner of a team, creating a website in Laravel. I\'d like to help with the coding, not just mechanics, direction, and github managing</p>\
        <p>&emsp;&emsp;&emsp;&emsp;Add more more examples of project to this website: I have about 4 more project in each category that I want to add when I get time</p>\
